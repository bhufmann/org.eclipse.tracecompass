 ...
 * @since 9.2
 */
public interface ITmfCoreProjectModelElement {
     ...
     */
    TmfCoreProjectElement getProject();
     ...
     */
    ITmfCoreProjectModelElement getParent();
     ...
     */
    List<ITmfCoreProjectModelElement> getChildren();
     ...
     * @since 3.1
     */
    default ITmfCoreProjectModelElement getChild(String name) {
        for (ITmfCoreProjectModelElement child : getChildren()) {
