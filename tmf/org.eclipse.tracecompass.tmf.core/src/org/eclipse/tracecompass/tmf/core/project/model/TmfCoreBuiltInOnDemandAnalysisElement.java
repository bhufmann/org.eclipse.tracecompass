 ...
 * @since 9.2
 */
public class TmfCoreBuiltInOnDemandAnalysisElement extends TmfCoreOnDemandAnalysisElement {
     ...
     */
    protected TmfCoreBuiltInOnDemandAnalysisElement(@NonNull String analysisName, @NonNull IResource resource, @NonNull TmfCoreOnDemandAnalysesElement parent, @NonNull IOnDemandAnalysis analysis) {
