 ...
 * @since 9.2
 */
public class TmfCoreOnDemandAnalysesElement extends TmfCoreProjectModelElement {
     ...
     *            The parent element
     */
    protected TmfCoreOnDemandAnalysesElement(IResource resource, TmfCoreCommonProjectElement parent) {
    ...
    protected synchronized void refreshChildren() {
        ...
        analyses.forEach(analysis -> {
            ...
            TmfCoreOnDemandAnalysisElement elem;

            if (analysis.isUserDefined()) {
                elem = new TmfCoreUserDefinedOnDemandAnalysisElement(analysis.getName(), analysisRes, this, analysis);
            } else {
                elem = new TmfCoreBuiltInOnDemandAnalysisElement(analysis.getName(), analysisRes, this, analysis);
            }
        ...
        getChildren().forEach(child -> ((TmfCoreProjectModelElement) child).refreshChildren());
    }
