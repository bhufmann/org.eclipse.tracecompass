 ...
 * @since 9.2
 */
public class TmfCoreReportsElement extends TmfCoreProjectModelElement {
     ...
     *            The parent element
     */
    protected TmfCoreReportsElement(IResource resource, TmfCoreCommonProjectElement parent) {
    ...
    public void addReport(IOnDemandAnalysisReport report) {
        ...
        TmfCoreReportElement elem = new TmfCoreReportElement(reportDisplayName, analysisRes, this, report);
        addChild(elem);
        refresh();
    }
