 ...
 * @since 9.2
 */
public class TmfCoreUserDefinedOnDemandAnalysisElement extends TmfCoreOnDemandAnalysisElement {
     ...
     */
    protected TmfCoreUserDefinedOnDemandAnalysisElement(@NonNull String analysisName, @NonNull IResource resource, @NonNull TmfCoreOnDemandAnalysesElement parent, @NonNull IOnDemandAnalysis analysis) {
